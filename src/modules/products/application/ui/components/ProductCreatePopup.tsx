...
const ProductCreatePopup = ({ onClose }: ProductCreatePopupProps) => {

  const { createProduct } = useProducts()
  const { categories, getCategories } = useCategories()

  const [newProductFormData, setNewProductFormData] = useState<NewProduct>(initialState)

  const handleCreateProduct = () => {
     createProduct(newProductFormData)
     onClose()
     setNewProductFormData(initialState)
  }
